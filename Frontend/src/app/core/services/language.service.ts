...
export class LanguageService {
  ...
  private readonly dutchTranslations = {
    ...
    'csv_export_started': 'CSV-export wordt gegenereerd. De download start automatisch zodra het bestand klaar is.',
    'csv_export_ready': 'CSV-export is klaar.',
    'csv_export_failed': 'CSV-export is mislukt.',
